gd <- read.csv("./data/Dementia-gradient_importance_Gradually_Decreasing_Deep_ordinal_regression.csv", stringsAsFactors = FALSE)
gi <- read.csv("./data/Dementia-gradient_importance_dementia_Gradually_Increasing_Deep_ordinal_regression.csv", stringsAsFactors = FALSE)
fi <- read.csv("./data/Dementia-gradient_importance_dementia_Fluctuating_Increasing_Deep_ordinal_regression.csv", stringsAsFactors = FALSE)
fd <- read.csv("./data/Dementia-gradient_importance_dementia_Fluctuating_Decreasing_Deep_ordinal_regression.csv", stringsAsFactors = FALSE)
...
# Save output
ggsave("./plot/Protein_selection-dementia-softened_gradient.pdf", final_plot, width = 12, height = 8, units = "in")
